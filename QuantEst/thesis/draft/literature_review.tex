...
\begin{enumerate}
    ...
    \item Parallel estimation \textbf{on other things} from Streaming Data: \\
        ...
        Parallel quantile estimation from streaming data has been an issue targeted by different algorithms. \citeauthor{ben-haimStreamingParallelDecision}  propose the Streaming Parallel Decision Tree (SPDT) algorithm \cite{ben-haimStreamingParallelDecision}, {an on-line histogram building method from streaming data at parallel processors}.
        \\\\
